...
import com.zdx.youpai.ui.vedio.ImportVideoActivity;
import com.zdx.youpai.ui.vedio.ImportVideoSelectActivity;
...
public class ImportVideoSelectionAdapter extends BaseAdapter {
	...
	public ImportVideoSelectionAdapter(Context context, int itemWidth) {
		...
		selectionVideoList = new ArrayList<ImportVideoSelectActivity.VideoRow>();
	}
