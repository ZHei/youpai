package com.zdx.youpai.ui.picture.adapter;
...
public class PicFragmentAdapter extends BaseAdapter{
    private final String TAG = "PicFragmentAdapter";
    ...
    public PicFragmentAdapter(Context context, List<ImageBean> list, PullToRefreshGridView mGridView){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = mInflater.inflate(R.layout.pic_group_item, null);
