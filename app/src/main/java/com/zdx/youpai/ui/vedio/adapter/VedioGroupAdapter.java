...
public class VedioGroupAdapter extends BaseAdapter {
    ...
    public VedioGroupAdapter(Context context, List<String> list, GridView mGridView) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = mInflater.inflate(R.layout.vedio_child_item, null);
