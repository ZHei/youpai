...
import com.zdx.youpai.YouPaiApplication;
import com.zdx.youpai.common.CommonIntentExtra;
import com.zdx.youpai.os.ThreadTask;
import com.zdx.youpai.ui.vedio.views.TextureVideoView;
import com.zdx.youpai.ui.vedio.views.VideoSelectionView;
import com.zdx.youpai.ui.vedio.views.VideoViewTouch;
import com.zdx.youpai.ui.vedio.widget.ProgressWheel;
import com.zdx.youpai.util.MediaUtils;

import java.io.File;

public class ImportVideoActivity extends VedioBaseActivity implements OnPreparedListener, TextureVideoView.OnPlayStateListener, OnInfoListener, OnVideoSizeChangedListener, OnErrorListener, OnSeekCompleteListener, OnClickListener, VideoSelectionView.OnSeekBarChangeListener, VideoSelectionView.OnSwich60sListener, VideoSelectionView.OnBackgroundColorListener, VideoSelectionView.OnVideoChangeScaleTypeListener {
	...
	protected com.zdx.youpai.ui.vedio.widget.ProgressWheel mProgressWheel;
	/** 中间画面拖动提示 */
		...
		if (StringUtils.isNotEmpty(url)) {
			new ThreadTask<Void, Void, File>() {
				...
				protected File doInBackground(Void... params) {
					File mThumbCacheDir = YouPaiApplication.getGifCacheDirectory();
	...
	private void startEncoding() {
		// 检测磁盘空间
		if (!YouPaiApplication.isAvailableSpace()) {
